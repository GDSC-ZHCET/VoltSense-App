...
class VoltageGraphWidget extends StatefulWidget {
  const VoltageGraphWidget({super.key});
...
class _VoltageGraphWidgetState extends State<VoltageGraphWidget> {
  ...
  Widget build(BuildContext context) {
    final voltageDataController = Get.find<GraphDataController>();
    final dark = VHelperFunctions.isDarkMode(context);

    return SingleChildScrollView(
      child: StreamBuilder<List<GraphData>>(
        stream: voltageDataController.voltageDataStream,
